...
public abstract class DrawerNavigationUI extends SuperUI {
    ...
    private void updateNavigationDrawer(){
        ...
        setupNavigationEntry(navDrawerEntryId, mNavViewsHolder.mCameraStreaming, new Intent(context,
                ConfigurationActivity.class).putExtra(ConfigurationActivity
                .EXTRA_CONFIG_SCREEN_ID, R.id.navigation_cameraStreaming));
    ...
    private static class NavDrawerViewHolder {
        ...
        final TextView mCameraStreaming;
        ...
        private NavDrawerViewHolder(View containerView){
            ...
            mCameraStreaming = (TextView) containerView.findViewById(R.id.navigation_cameraStreaming);
        }
    }
}
